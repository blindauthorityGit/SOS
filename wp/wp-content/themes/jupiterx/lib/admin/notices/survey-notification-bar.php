...
class JupiterX_Admin_Notice_Survey_Notification_Bar {
	...
	public function admin_notice() {
		...
		$logo = '<div class="jupiterx-survey-notification-bar-notice-logo">
			<img src="' . esc_url( JUPITERX_ADMIN_ASSETS_URL . 'images/jupiterx-notice-logo.png' ) . '" alt="' . esc_html( 'Jupiter X', 'jupiterx' ) . '" />
		</div>';

		printf( '<div data-nonce="%s" class="jupiterx-survey-notification-bar-notice notice notice-warning is-dismissible"><div class="jupiterx-survey-notification-bar-notice-inner">%s<div class="jupiterx-survey-notification-bar-notice-content"><p>%s</p></div></div></div>', $nonce, $logo, $message ); // phpcs:ignore WordPress.Security
	}
