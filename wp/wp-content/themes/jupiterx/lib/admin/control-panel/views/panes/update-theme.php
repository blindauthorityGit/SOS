...
<div class="jupiterx-cp-pane-box" id="jupiterx-cp-updates-downgrades">
	<h3>
		...
		?>
		<?php jupiterx_the_help_link( 'http://help.artbees.net/maintenance/updating-the-theme/updating-jupiter-x-theme-automatically', __( 'Updating Jupiter X theme automatically', 'jupiterx' ) ); ?>
	</h3>
