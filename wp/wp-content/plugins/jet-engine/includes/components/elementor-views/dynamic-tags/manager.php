...
if ( ! class_exists( 'Jet_Engine_Dynamic_Tags_Manager' ) ) {
	...
	class Jet_Engine_Dynamic_Tags_Manager {
		...
		function __construct() {
			...
			add_filter( 'jet-engine/elementor-views/frontend/listing-content', array( $this, 'add_listing_item_dynamic_css' ), 10, 2 );
			add_filter( 'jet-engine/compatibility/popup-package/the_content',  array( $this, 'add_popup_item_dynamic_css' ),  10, 2 );
