	...
	class JupiterX_Widget extends WP_Widget {
		...
		public function scripts() {
			...
			if ( ! wp_script_is( 'jquery-elementor-select2', 'enqueued' ) ) {
				wp_enqueue_script( 'jupiterx-select2', JUPITERX_ADMIN_URL . 'assets/lib/select2/select2.full.js', [ 'jquery' ], JUPITERX_VERSION, false );
			}
		}
		...
		public function styles() {
			...
			if ( ! wp_style_is( 'select2', 'enqueued' ) ) {
				wp_enqueue_style( 'jupiterx-select2', JUPITERX_ADMIN_URL . 'assets/lib/select2/select2.css', [], JUPITERX_VERSION );
			}
		}
